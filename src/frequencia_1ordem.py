...
plt.suptitle("Bode da Malha Aberta (L = C*G)", fontsize=16)
plt.savefig(os.path.join("imagens", "fqA_controlador.png" ))
plt.show()
...
plt.savefig(os.path.join("imagens", "fqF_controlador.png" ))
plt.show()
