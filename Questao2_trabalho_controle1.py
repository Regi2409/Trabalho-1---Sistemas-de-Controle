...
plt.plot(t, y3, label="G(s) (Planta")
plt.axhline(0.98, color="red", linestyle="--", label="Erro mínimo")
plt.axhline(1.02, color="green", linestyle="--", label="Erro máximo")
...
plt.savefig(os.path.join("imagens", "controlador_A.png" ))
plt.show()
